...
class HashiCorpVaultPlugin extends Plugin {
	...
	void initialize() {
		...
		this.setAuthor("Chris Taylor")
		this.setSourceCodeLocationUrl("")
		this.setIssueTrackerUrl("")
	...
	private getSupportedEngines() {
		def rtn = ""
		HashiCorpVaultCypherModule.SUPPORTED_ENGINES?.each{ k, v -> rtn += v.getName() + " Engine\n" }
		return rtn
	}
